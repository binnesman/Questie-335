...
function QuestieDB.IsDoable(questId, debugPrint)
    ...
    -- activeChildQuests
    -- Race requirement
    -- Single Pre-quest not complete
    -- Class requirement
    -- Rep requirements
    -- Profession requirements
    -- Group Pre-quest
    -- Inactive parent quest
    -- Follow up quests complete or in quest log
    -- exclusive completed or accepted
    -- Inactive daily quest
    ...
    if IsQuestFlaggedCompleted(questId) then
        if debugPrint then Questie:Debug(Questie.DEBUG_SPAM, "[QuestieDB.IsDoable] Player has already completed quest " .. questId) end
        return false
    end
