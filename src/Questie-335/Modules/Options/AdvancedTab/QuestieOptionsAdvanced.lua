...
function QuestieOptions.tabs.advanced:Initialize()
    ...
    return {
        ...
        args = {
            ...
            Spacer_G = QuestieOptionsUtils:Spacer(4.5),
            GetCompleted = {
                type = "execute",
                order = 4.65,
                name = function() return l10n('Force Get Completed'); end,
                desc = function() return l10n('Run GetQuestsCompleted without waiting for event'); end,
                func = function (_, _)
                    QuestieCompat:ForceGetCompletedQuests()
                end,
            },
            Spacer_H = QuestieOptionsUtils:Spacer(4.7),
            github_text = {
                type = "description",
                order = 4.8,
